...
class CollectCurrency(CollectData):
    def __init__(self, names, mastercurr = 'pln', date0 = None, daten = None, nyears = 10):
    ...
    def collect_currency(self):
        ...
        for name in self.names:
            data[i] = pd.read_csv(f'https://stooq.pl/q/d/l/?s={name}{self.mastercurr}&d1={self.date0_str}&d2={self.daten_str}&i=d')[['Data', 'Zamkniecie']]
            j=0
...
print(curr.X)
print(curr.X.values)
print(curr.X.values[:,1])

curr.check_data()
curr.plot_data(dpi = 150)
